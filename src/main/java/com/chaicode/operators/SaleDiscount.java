 ...
 *
 * <p>
 * An e-commerce site runs flash sales. Given the original price and discount
 * percentage,
 ...
 * <li>If originalPrice is negative or discountPercent is not between 0 and 100
 * inclusive, return -1.0</li>
 * </ul>
 *
...
public final class SaleDiscount {
    ...
    public static double applyDiscount(double originalPrice, int discountPercent) {
        ...
        double salePrice = originalPrice * (1 - discountPercent / 100.0);
